...
import 'schema/terapeutas_record.dart';
import 'schema/progreso_usuario_record.dart';
...
export 'schema/terapeutas_record.dart';
export 'schema/progreso_usuario_record.dart';
...
/// Functions to query TerapeutasRecords (as a Stream and as a Future).
Future<int> queryTerapeutasRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      TerapeutasRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<TerapeutasRecord>> queryTerapeutasRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      TerapeutasRecord.collection,
      TerapeutasRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<TerapeutasRecord>> queryTerapeutasRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query ProgresoUsuarioRecords (as a Stream and as a Future).
Future<int> queryProgresoUsuarioRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ProgresoUsuarioRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ProgresoUsuarioRecord>> queryProgresoUsuarioRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      ProgresoUsuarioRecord.collection(parent),
      ProgresoUsuarioRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ProgresoUsuarioRecord>> queryProgresoUsuarioRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
